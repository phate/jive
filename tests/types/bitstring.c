...
static int types_bitstring_arithmetic_test_bitand(void)
{
	...
	auto and0 = jive_bitand(32, {s0, s1});
	auto and1 = jive_bitand(32, {c0, c1});
...
static int types_bitstring_arithmetic_test_bitashr(void)
{
	...
	auto ashr0 = jive_bitashr(32, s0, s1);
	auto ashr1 = jive_bitashr(32, c0, c2);
	auto ashr2 = jive_bitashr(32, c0, c3);
	auto ashr3 = jive_bitashr(32, c1, c2);
	auto ashr4 = jive_bitashr(32, c1, c3);
...
static int types_bitstring_arithmetic_test_bitdifference(void)
{
	...
	auto diff = jive_bitsub(32, s0, s1);
...
static int types_bitstring_arithmetic_test_bitnegate(void)
{
	...
	auto neg0 = jive_bitneg(32, s0);
	auto neg1 = jive_bitneg(32, c0);
	auto neg2 = jive_bitneg(32, neg1);
...
static int types_bitstring_arithmetic_test_bitnot(void)
{
	...
	auto not0 = jive_bitnot(32, s0);
	auto not1 = jive_bitnot(32, c0);
	auto not2 = jive_bitnot(32, not1);
...
static int types_bitstring_arithmetic_test_bitor(void)
{
	...
	auto or0 = jive_bitor(32, {s0, s1});
	auto or1 = jive_bitor(32, {c0, c1});
...
static int types_bitstring_arithmetic_test_bitproduct(void)
{
	...
	auto product0 = jive_bitmul(32, {s0, s1});
	auto product1 = jive_bitmul(32, {c0, c1});
...
static int types_bitstring_arithmetic_test_bitshiproduct(void)
{
	...
	auto shiproduct = jive_bitsmulh(32, s0, s1);
...
static int types_bitstring_arithmetic_test_bitshl(void)
{
	...
	auto shl0 = jive_bitshl(32, s0, s1);
	auto shl1 = jive_bitshl(32, c0, c1);
	auto shl2 = jive_bitshl(32, c0, c2);
...
static int types_bitstring_arithmetic_test_bitshr(void)
{
	...
	auto shr0 = jive_bitshr(32, s0, s1);
	auto shr1 = jive_bitshr(32, c0, c1);
	auto shr2 = jive_bitshr(32, c0, c2);
...
static int types_bitstring_arithmetic_test_bitsmod(void)
{
	...
	auto smod0 = jive_bitsmod(32, s0, s1);
	auto smod1 = jive_bitsmod(32, c0, c1);
...
static int types_bitstring_arithmetic_test_bitsquotient(void)
{
	...
	auto squot0 = jive_bitsdiv(32, s0, s1);
	auto squot1 = jive_bitsdiv(32, c0, c1);
...
static int types_bitstring_arithmetic_test_bitsum(void)
{
	...
	auto sum0 = jive_bitsum(32, {s0, s1});
	auto sum1 = jive_bitsum(32, {c0, c1});
...
static int types_bitstring_arithmetic_test_bituhiproduct(void)
{
	...
	auto uhiproduct = jive_bitumulh(32, s0, s1);
...
static int types_bitstring_arithmetic_test_bitumod(void)
{
	...
	auto umod0 = jive_bitumod(32, s0, s1);
	auto umod1 = jive_bitumod(32, c0, c1);
...
static int types_bitstring_arithmetic_test_bituquotient(void)
{
	...
	auto uquot0 = jive_bitudiv(32, s0, s1);
	auto uquot1 = jive_bitudiv(32, c0, c1);
...
static int types_bitstring_arithmetic_test_bitxor(void)
{
	...
	auto xor0 = jive_bitxor(32, {s0, s1});
	auto xor1 = jive_bitxor(32, {c0, c1});
...
static int types_bitstring_comparison_test_bitequal(void)
{
	...
	auto equal0 = jive_bitequal(32, s0, s1);
	auto equal1 = jive_bitequal(32, c0, c0);
	auto equal2 = jive_bitequal(32, c0, c1);
	auto equal3 = jive_bitequal(32, c0, c2);
...
static int types_bitstring_comparison_test_bitnotequal(void)
{
	...
	auto nequal0 = jive_bitnotequal(32, s0, s1);
	auto nequal1 = jive_bitnotequal(32, c0, c0);
	auto nequal2 = jive_bitnotequal(32, c0, c1);
	auto nequal3 = jive_bitnotequal(32, c0, c2);
...
static int types_bitstring_comparison_test_bitsgreater(void)
{
	...
	auto sgreater0 = jive_bitsgreater(32, s0, s1);
	auto sgreater1 = jive_bitsgreater(32, c0, c1);
	auto sgreater2 = jive_bitsgreater(32, c1, c0);
	auto sgreater3 = jive_bitsgreater(32, s0, c2);
	auto sgreater4 = jive_bitsgreater(32, c3, s1);
...
static int types_bitstring_comparison_test_bitsgreatereq(void)
{
	...
	auto sgreatereq0 = jive_bitsgreatereq(32, s0, s1);
	auto sgreatereq1 = jive_bitsgreatereq(32, c0, c1);
	auto sgreatereq2 = jive_bitsgreatereq(32, c1, c0);
	auto sgreatereq3 = jive_bitsgreatereq(32, c0, c0);
	auto sgreatereq4 = jive_bitsgreatereq(32, c2, s0);
	auto sgreatereq5 = jive_bitsgreatereq(32, s1, c3);
...
static int types_bitstring_comparison_test_bitsless(void)
{
	...
	auto sless0 = jive_bitsless(32, s0, s1);
	auto sless1 = jive_bitsless(32, c0, c1);
	auto sless2 = jive_bitsless(32, c1, c0);
	auto sless3 = jive_bitsless(32, c2, s0);
	auto sless4 = jive_bitsless(32, s1, c3);
...
static int types_bitstring_comparison_test_bitslesseq(void)
{
	...
	auto slesseq0 = jive_bitslesseq(32, s0, s1);
	auto slesseq1 = jive_bitslesseq(32, c0, c1);
	auto slesseq2 = jive_bitslesseq(32, c0, c0);
	auto slesseq3 = jive_bitslesseq(32, c1, c0);
	auto slesseq4 = jive_bitslesseq(32, s0, c2);
	auto slesseq5 = jive_bitslesseq(32, c3, s1);
...
static int types_bitstring_comparison_test_bitugreater(void)
{
	...
	auto ugreater0 = jive_bitugreater(32, s0, s1);
	auto ugreater1 = jive_bitugreater(32, c0, c1);
	auto ugreater2 = jive_bitugreater(32, c1, c0);
	auto ugreater3 = jive_bitugreater(32, s0, c2);
	auto ugreater4 = jive_bitugreater(32, c3, s1);
...
static int types_bitstring_comparison_test_bitugreatereq(void)
{
	...
	auto ugreatereq0 = jive_bitugreatereq(32, s0, s1);
	auto ugreatereq1 = jive_bitugreatereq(32, c0, c1);
	auto ugreatereq2 = jive_bitugreatereq(32, c1, c0);
	auto ugreatereq3 = jive_bitugreatereq(32, c0, c0);
	auto ugreatereq4 = jive_bitugreatereq(32, c2, s0);
	auto ugreatereq5 = jive_bitugreatereq(32, s1, c3);
...
static int types_bitstring_comparison_test_bituless(void)
{
	...
	auto uless0 = jive_bituless(32, s0, s1);
	auto uless1 = jive_bituless(32, c0, c1);
	auto uless2 = jive_bituless(32, c1, c0);
	auto uless3 = jive_bituless(32, c2, s0);
	auto uless4 = jive_bituless(32, s1, c3);
...
static int types_bitstring_comparison_test_bitulesseq(void)
{
	...
	auto ulesseq0 = jive_bitulesseq(32, s0, s1);
	auto ulesseq1 = jive_bitulesseq(32, c0, c1);
	auto ulesseq2 = jive_bitulesseq(32, c0, c0);
	auto ulesseq3 = jive_bitulesseq(32, c1, c0);
	auto ulesseq4 = jive_bitulesseq(32, s0, c2);
	auto ulesseq5 = jive_bitulesseq(32, c3, s1);
...
static int types_bitstring_test_arithmetic(void)
{
	...
	jive_bitsub(4, c0, c1);
	jive_bitsmulh(4, c0, c1);
	jive_bitumulh(4, c0, c1);
	jive_bitudiv(4, c0, c1);
	jive_bitsdiv(4, c0, c1);
	jive_bitumod(4, c0, c1);
	jive_bitsmod(4, c0, c1);
	jive_bitshl(4, c0, c1);
	jive_bitshr(4, c0, c1);
	jive_bitashr(4, c0, c1);
...
static int types_bitstring_test_normalize(void)
{
	...
	auto sum1 = jive_bitsum(32, {sum0, c1});
...
static int types_bitstring_test_reduction(void)
{
	...
	assert_constant(jive_bitand(4, {a, b}), 4, "1000");
	assert_constant(jive_bitor(4, {a, b}), 4, "1110");
	assert_constant(jive_bitxor(4, {a, b}), 4, "0110");
	assert_constant(jive_bitsum(4, {a, b}), 4, "0001");
	assert_constant(jive_bitmul(4, {a, b}), 4, "1111");
	assert_constant(jive_bitconcat({a, b}), 8, "11001010");
	assert_constant(jive_bitneg(4, a), 4, "1011");
	assert_constant(jive_bitneg(4, b), 4, "1101");
