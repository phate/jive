...
typedef struct jive_cfg_enter_node jive_cfg_enter_node;

struct jive_cfg_enter_node {
	jive_cfg_node base;
};
...
typedef struct jive_cfg_exit_node jive_cfg_exit_node;

struct jive_cfg_exit_node {
	jive_cfg_node base;
};
