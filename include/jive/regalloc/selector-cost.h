...
#ifndef JIVE_REGALLOC_SELECTOR_COST_H
#define JIVE_REGALLOC_SELECTOR_COST_H
...
public:
	...
	node_selection_order(master_selector_cost * master, jive_node * node);
...
public:
	...
	friend class region_selector_cost;
	friend class master_selector_cost;
};
...
class region_selector_cost final : public region_selector {
public:
	virtual
	~region_selector_cost() noexcept;
...
private:
	...
	detail::intrusive_hash_anchor<region_selector_cost> hash_chain;
	typedef detail::intrusive_hash_accessor <
		const jive_region *,
		region_selector_cost,
		&region_selector_cost::region_,
		&region_selector_cost::hash_chain
	> hash_chain_accessor;
...
class master_selector_cost final : public master_selector {
public:
	virtual
	~master_selector_cost() noexcept;

	master_selector_cost(jive_shaped_graph * shaped_graph);
...
private:
	...
	typedef detail::owner_intrusive_hash <
		const jive_region *,
		region_selector_cost,
		region_selector_cost::hash_chain_accessor
	> region_selector_cost_hash;

	region_selector_cost_hash region_map_;
