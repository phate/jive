...
extern const jive_node_class JIVE_ABSTRACT_GAMMA_SLAVE_NODE;
extern const jive_node_class JIVE_ABSTRACT_GAMMA_MASTER_NODE;
...
typedef jive_node jive_gamma_master_node;
