...
extern const jive_node_class JIVE_BITULESSEQ_NODE;

namespace jive {
namespace bits {

class ulesseq_operation final : public compare_op {
public:
	virtual ~ulesseq_operation() noexcept;

	inline ulesseq_operation(
