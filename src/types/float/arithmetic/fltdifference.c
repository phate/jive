...
static jive_node *
jive_fltdifference_node_create_(struct jive_region * region, const jive_node_attrs * attrs,
...
static jive_node *
jive_fltdifference_node_create_(jive_region * region, const jive_node_attrs * attrs,
...
jive_output *
jive_fltdifference(struct jive_output * op1, struct jive_output * op2)
{
	jive_region * region = jive_region_innermost(2, (jive_output *[]){op1, op2});
	return jive_binary_operation_normalized_create(&JIVE_FLTDIFFERENCE_NODE, region, NULL,
