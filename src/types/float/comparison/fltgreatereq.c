...
static jive_node *
jive_fltgreatereq_node_create_(struct jive_region * region, const jive_node_attrs * attrs,
	size_t noperands, jive::output * const operands[]);

const jive_fltcomparison_operation_class JIVE_FLTGREATEREQ_NODE_ = {
	base : { /* jive_binary_operation_class */
		base : { /* jive_node_class */
			...
			create : jive_fltgreatereq_node_create_, /* override */
		},
	...
	type : jive_fltcmp_code_greatereq
};

static void
jive_fltgreatereq_node_init_(struct jive_node * self, struct jive_region * region,
	...
	size_t noperands, struct jive::output * const operands[])
{
	...
	jive_node * node = jive::create_operation_node(jive::flt::greatereq_operation());
	node->class_ = &JIVE_FLTGREATEREQ_NODE;
	jive_fltgreatereq_node_init_(node, region, operands[0], operands[1]);

	return node;
}

jive::output *
jive_fltgreatereq(jive::output * op1, jive::output * op2)
{
