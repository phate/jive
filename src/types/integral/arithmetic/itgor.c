...
#include <jive/types/integral/arithmetic/itgor.h>
#include <jive/types/integral/itgoperation-classes-private.h>
#include <jive/types/integral/itgtype.h>
#include <jive/vsdg/node-private.h>

static jive_node *
jive_itgor_node_create_(struct jive_region * region, const jive_node_attrs * attrs,
	size_t noperands, struct jive_output * const operands[]);

const jive_itgbinary_operation_class JIVE_ITGOR_NODE_ = {
	...
	.type = jive_itgop_code_or
};

static void
jive_itgor_node_init_(jive_itgor_node * self, jive_region * region,
	...
	size_t noperands, jive_output * const operands[])
{
	...
	node->base.class_ = &JIVE_ITGOR_NODE;
...
jive_itgor(struct jive_output * operand1, struct jive_output * operand2)
{
	...
	return jive_binary_operation_create_normalized(&JIVE_ITGOR_NODE_.base, graph, NULL, 2,
