...
const jive::resource_class_demotion  tmparray0[] = {
			{CLS(gpr_eax), {CLS(flags), CLS(gpr_eax)}},
			{STACK4, {CLS(flags), CLS(gpr_eax), STACK4}},
			{nullptr, {}}
		};
...
const jive::resource_class_demotion  tmparray1[] = {{STACK4, {CLS(gpr), STACK4}}, {nullptr, {}}};
...
const jive::resource_class_demotion  tmparray2[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray3[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray4[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray5[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray6[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray7[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray8[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray9[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray10[] = {
	{CLS(gpr), {CLS(gpr), CLS(gpr)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray11[] = {
	{STACK4, {CLS(fp), STACK4}},
	{nullptr, {}}
};
...
const jive::resource_class_demotion  tmparray12[] = {
	{CLS(fp), {CLS(fp), CLS(fp)}},
	{STACK4, {CLS(gpr), STACK4}},
	{nullptr, {}}
};
